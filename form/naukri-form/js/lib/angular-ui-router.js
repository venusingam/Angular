    ...
    function $UrlMatcherFactory() {
        ...
        ParamSet.prototype = {
            ...
            $$keys: function() {
                ...
                while (parent) { chain.push(parent);
    ...
    function $ViewDirective($state, $injector, $uiViewScroll, $interpolate, $q) {
        ...
        function getRenderer(attrs, scope) {
            var statics = function() {
                return {
                    enter: function(element, target, cb) { target.after(element);
                        cb(); },
                    leave: function(element, cb) { element.remove();
                        cb(); }
                };
            };
            ...
            if ($animator) {
                ...
                return {
                    enter: function(element, target, cb) { animate.enter(element, null, target);
                        cb(); },
                    leave: function(element, cb) { animate.leave(element);
                        cb(); }
                };
            }
